...
exports = module.exports = (options) => {
    ...
    const providerUri = settings.providerUri + settings.tenant;
    const defaultGraphParams = { 'api-version': settings.apiVersion };
    ...
    return {
        ...
        profile: (credentials, params, get, callback) => {
            ...
            return settings.entities.forEach((request) => {
                ...
                const graphParams = Hoek.clone(defaultGraphParams);
                Hoek.merge(graphParams, request.params || {});

                return get(uri, graphParams, (data) => {
